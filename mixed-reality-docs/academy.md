...
layout: LandingPage
title: 学院的代码、 教程和课程
description: 混合现实学院提供混合的现实开发的代码示例和教程。
author: keveleigh
ms.author: kurtie
ms.date: 03/21/2018
ms.topic: article
...
ms.locfileid: "59592161"
---
# <a name="academy-code-tutorials-and-lessons"></a>学院： 代码、 教程和课程
...
我们还在旧金山的反应堆空间提供的现场中混合现实学院。 如果您正在寻找有关物理学院空间或即将举办的活动的信息[单击此处](#microsoft-reactor)或滚动到该页的底部。
...
<h3><a href="https://developer.microsoft.com/reactor/">在旧金山 Microsoft 反应堆</a></h3>
<p>
在旧金山，Microsoft 反应堆位于 680 folsom 举办 SOMA，用作混合现实捕获 Studio 和混合现实学院的旗舰位置中。 它是开发人员和创建者可以开始构建 Microsoft HoloLens 和 Windows 混合现实耳机的混合的现实体验进行学习的地方。</p>

[查找即将举行的会议、 研讨会和编程马拉松的公告](sf-academy-events.md)
