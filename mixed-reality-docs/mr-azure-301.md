...
<span data-ttu-id="8c4c5-116">完成本课程时，之后您将拥有一个混合的现实应用程序，将能够执行以下操作：</span><span class="sxs-lookup"><span data-stu-id="8c4c5-116">Upon completion of this course, you will have a mixed reality application which will be able to do the following:</span></span>
...
## <a name="prerequisites"></a><span data-ttu-id="8c4c5-132">系统必备</span><span class="sxs-lookup"><span data-stu-id="8c4c5-132">Prerequisites</span></span>
...
- <span data-ttu-id="8c4c5-150">如果您使用的麦克风和耳机连接到 （或内置于） 将耳机，请确保选择"当我 wear 我耳机时，切换到耳机式麦克风"中打开**设置 > 混合现实 > 音频和语音**。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-150">If you're using a microphone and headphones connected to (or built-in to) your headset, make sure the option “When I wear my headset, switch to headset mic” is turned on in **Settings > Mixed reality > Audio and speech**.</span></span>
...
5.  <span data-ttu-id="8c4c5-417">然后，添加以下变量内的*MicrophoneManager*类：</span><span class="sxs-lookup"><span data-stu-id="8c4c5-417">Then, add the following variables inside the *MicrophoneManager* class:</span></span>
...
10. <span data-ttu-id="8c4c5-426">请确保在返回到 Unity 之前的 Visual Studio 中保存所做的更改。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-426">Be sure to save your changes in Visual Studio before returning to Unity.</span></span>
...
5.  <span data-ttu-id="8c4c5-441">然后添加以下变量内的*转换器*类：</span><span class="sxs-lookup"><span data-stu-id="8c4c5-441">Then add the following variables inside the *Translator* class:</span></span>
...
10. <span data-ttu-id="8c4c5-459">请务必保存中所做的更改*Visual Studio*才会回到*Unity*。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-459">Be sure to save your changes in *Visual Studio* before returning to *Unity*.</span></span>

## <a name="chapter-8--configure-the-unity-scene"></a><span data-ttu-id="8c4c5-460">章 8 – 配置 Unity 场景</span><span class="sxs-lookup"><span data-stu-id="8c4c5-460">Chapter 8 – Configure the Unity Scene</span></span>

1.  <span data-ttu-id="8c4c5-461">返回在 Unity 编辑器中，单击并拖动*结果*类*从\***脚本**文件夹**Main Camera**中对象*层次结构面板\*。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-461">Back in the Unity Editor, click and drag the *Results* class *from* the **Scripts** folder to the **Main Camera** object in the *Hierarchy Panel*.</span></span>
2.  <span data-ttu-id="8c4c5-462">单击**Main Camera**并查看*检查器面板*。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-462">Click on the **Main Camera** and look at the *Inspector Panel*.</span></span> <span data-ttu-id="8c4c5-463">您将在新添加发现*脚本*组件，有四个字段的值为空。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-463">You will notice that within the newly added *Script* component, there are four fields with empty values.</span></span> <span data-ttu-id="8c4c5-464">这些是对在代码中的属性的输出引用。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-464">These are the output references to the properties in the code.</span></span> 
3.  <span data-ttu-id="8c4c5-465">拖动相应**文本**中的对象*层次结构面板*到四个槽，如下图中所示。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-465">Drag the appropriate **Text** objects from the *Hierarchy Panel* to those four slots, as shown in the image below.</span></span>

    ![使用指定的值更新目标的引用。](images/AzureLabs-Lab1-34.png)
  
4.  <span data-ttu-id="8c4c5-467">接下来，单击并拖动*转换器*类派生**脚本**文件夹**Main Camera**对象中*层次结构面板*。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-467">Next, click and drag the *Translator* class from the **Scripts** folder to the **Main Camera** object in the *Hierarchy Panel*.</span></span> 
5.  <span data-ttu-id="8c4c5-468">然后，单击并拖动*MicrophoneManager*类派生**脚本**文件夹**Main Camera**对象中*层次结构面板*。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-468">Then, click and drag the *MicrophoneManager* class from the **Scripts** folder to the **Main Camera** object in the *Hierarchy Panel*.</span></span> 
6.  <span data-ttu-id="8c4c5-469">最后，单击**Main Camera**并查看*检查器面板*。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-469">Lastly, click on the **Main Camera** and look at the *Inspector Panel*.</span></span> <span data-ttu-id="8c4c5-470">您将注意到在拖动的脚本中，有两个下拉列表框，您可以设置的语言。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-470">You will notice that in the script you dragged on, there are two drop down boxes that will allow you to set the languages.</span></span>
 
    ![请确保输入预期的翻译语言。](images/AzureLabs-Lab1-35.png)

## <a name="chapter-9--test-in-mixed-reality"></a><span data-ttu-id="8c4c5-472">第 9 章 – 混合现实中的测试</span><span class="sxs-lookup"><span data-stu-id="8c4c5-472">Chapter 9 – Test in mixed reality</span></span>

<span data-ttu-id="8c4c5-473">此时您需要测试已正确地实现场景。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-473">At this point you need to test that the Scene has been properly implemented.</span></span>

<span data-ttu-id="8c4c5-474">请确保：</span><span class="sxs-lookup"><span data-stu-id="8c4c5-474">Ensure that:</span></span>

- <span data-ttu-id="8c4c5-475">中所述的所有设置[第 1 章](#chapter-1--the-azure-portal)正确设置。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-475">All the settings mentioned in [Chapter 1](#chapter-1--the-azure-portal) are set correctly.</span></span> 
- <span data-ttu-id="8c4c5-476">*结果*，*转换器*，并*MicrophoneManager*，脚本附加到**Main Camera**对象。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-476">The *Results*, *Translator*, and *MicrophoneManager*, scripts are attached to the **Main Camera** object.</span></span> 
- <span data-ttu-id="8c4c5-477">已放置你*Azure 文本翻译 API*服务**密钥**内**authorizationKey**变量内*转换器*脚本。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-477">You have placed your *Azure Translator Text API* Service **Key** within the **authorizationKey** variable within the *Translator* Script.</span></span>  
- <span data-ttu-id="8c4c5-478">中的所有字段*主相机检查器面板*正确分配。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-478">All the fields in the *Main Camera Inspector Panel* are assigned properly.</span></span>
- <span data-ttu-id="8c4c5-479">您的麦克风正在运行您的场景时 (如果没有，请检查是否附加的麦克风*默认*设备，并且您具有[它正确设置了在 Windows 内](https://support.microsoft.com/en-au/help/4027981/windows-how-to-set-up-and-test-microphones-in-windows-10))。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-479">Your microphone is working when running your scene (if not, check that your attached microphone is the *default* device, and that you have [set it up correctly within Windows](https://support.microsoft.com/en-au/help/4027981/windows-how-to-set-up-and-test-microphones-in-windows-10)).</span></span>

<span data-ttu-id="8c4c5-480">可以通过按测试沉浸式头戴式**播放**按钮*Unity 编辑器*。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-480">You can test the immersive headset by pressing the **Play** button in the *Unity Editor*.</span></span>
<span data-ttu-id="8c4c5-481">应用程序应通过附加的沉浸式头戴式正常运行。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-481">The App should be functioning through the attached immersive headset.</span></span>

> [!WARNING]  
> <span data-ttu-id="8c4c5-482">如果看到有关更改默认音频设备 Unity 控制台中的错误，场景可能无法按预期方式。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-482">If you see an error in the Unity console about the default audio device changing, the scene may not function as expected.</span></span> <span data-ttu-id="8c4c5-483">这是由于混合的现实门户内置麦克风耳机具有它们的处理的方式。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-483">This is due to the way the mixed reality portal deals with built-in microphones for headsets that have them.</span></span> <span data-ttu-id="8c4c5-484">如果看到此错误，只需停止场景并重新启动它，并且应该可以正常为预期。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-484">If you see this error, simply stop the scene and start it again and things should work as expected.</span></span>

## <a name="chapter-10--build-the-uwp-solution-and-sideload-on-local-machine"></a><span data-ttu-id="8c4c5-485">章第 10-构建 UWP 解决方案和本地计算机上旁加载</span><span class="sxs-lookup"><span data-stu-id="8c4c5-485">Chapter 10 – Build the UWP solution and sideload on local machine</span></span>

<span data-ttu-id="8c4c5-486">此项目的 Unity 部分所需的所有内容现已完成，因此它是从 Unity 生成的时间。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-486">Everything needed for the Unity section of this project has now been completed, so it is time to build it from Unity.</span></span>

1.  <span data-ttu-id="8c4c5-487">导航到**生成设置**:**文件 > 生成设置...**</span><span class="sxs-lookup"><span data-stu-id="8c4c5-487">Navigate to **Build Settings**: **File > Build Settings...**</span></span>
2.  <span data-ttu-id="8c4c5-488">从**生成设置**窗口中，单击**生成**。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-488">From the **Build Settings** window, click **Build**.</span></span>

    ![生成 Unity 场景。](images/AzureLabs-Lab1-36.png)
  
3.  <span data-ttu-id="8c4c5-490">如果尚不存在，则勾选**UnityC#项目**。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-490">If not already, tick **Unity C# Projects**.</span></span>
4.  <span data-ttu-id="8c4c5-491">单击“生成” 。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-491">Click **Build**.</span></span> <span data-ttu-id="8c4c5-492">将启动 unity*文件资源管理器*窗口中，需要创建，然后选择要生成该应用程序的文件夹。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-492">Unity will launch a *File Explorer* window, where you need to create and then select a folder to build the app into.</span></span> <span data-ttu-id="8c4c5-493">现在，创建该文件夹并将其命名*应用*。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-493">Create that folder now, and name it *App*.</span></span> <span data-ttu-id="8c4c5-494">然后使用*应用程序*文件夹选择，按**选择文件夹**。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-494">Then with the *App* folder selected, press **Select Folder**.</span></span> 
5.  <span data-ttu-id="8c4c5-495">Unity 将开始构建您的项目*应用*文件夹。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-495">Unity will begin building your project to the *App* folder.</span></span> 
6.  <span data-ttu-id="8c4c5-496">一次 Unity 已完成的生成 （它可能需要一些时间），它将打开*文件资源管理器*窗口在生成的位置 （检查任务栏中，因为它可能不总是会显示您的窗口上方，但会通知你添加了一个新窗口）。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-496">Once Unity has finished building (it might take some time), it will open a *File Explorer* window at the location of your build (check your task bar, as it may not always appear above your windows, but will notify you of the addition of a new window).</span></span>

## <a name="chapter-11--deploy-your-application"></a><span data-ttu-id="8c4c5-497">第 11 章 – 部署你的应用程序</span><span class="sxs-lookup"><span data-stu-id="8c4c5-497">Chapter 11 – Deploy your application</span></span>

<span data-ttu-id="8c4c5-498">若要部署你的应用程序：</span><span class="sxs-lookup"><span data-stu-id="8c4c5-498">To deploy your application:</span></span>

1.  <span data-ttu-id="8c4c5-499">导航到新的 Unity 生成 (*应用程序*文件夹)，然后打开解决方案文件与*Visual Studio*。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-499">Navigate to your new Unity build (the *App* folder) and open the solution file with *Visual Studio*.</span></span>
2.  <span data-ttu-id="8c4c5-500">在解决方案配置中，选择**调试**。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-500">In the Solution Configuration select **Debug**.</span></span>
3.  <span data-ttu-id="8c4c5-501">在解决方案平台中，选择**x86**，**本地计算机**。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-501">In the Solution Platform, select **x86**, **Local Machine**.</span></span> 

    > <span data-ttu-id="8c4c5-502">对于 Microsoft HoloLens，您可能会发现它更轻松地将其设置为*远程计算机*，因此您不已接入到你的计算机。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-502">For the Microsoft HoloLens, you may find it easier to set this to *Remote Machine*, so that you are not tethered to your computer.</span></span> <span data-ttu-id="8c4c5-503">不过，需要还执行以下操作：</span><span class="sxs-lookup"><span data-stu-id="8c4c5-503">Though, you will need to also do the following:</span></span>
    > - <span data-ttu-id="8c4c5-504">知道**IP 地址**的你 HoloLens，在中找到*设置 > 网络和 Internet > Wi-fi > 高级选项*; IPv4 是应使用的地址。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-504">Know the **IP Address** of your HoloLens, which can be found within the *Settings > Network & Internet > Wi-Fi > Advanced Options*; the IPv4 is the address you should use.</span></span> 
    > - <span data-ttu-id="8c4c5-505">请确保*开发人员模式*是**上**; 中找到*设置 > 更新和安全 > 面向开发人员*。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-505">Ensure *Developer Mode* is **On**; found in *Settings > Update & Security > For developers*.</span></span>

    ![部署从 Visual Studio 解决方案。](images/AzureLabs-Lab1-37.png)
    
 
4.  <span data-ttu-id="8c4c5-507">转到**生成菜单**，然后单击**部署解决方案**旁加载到您的 PC 应用程序。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-507">Go to **Build menu** and click on **Deploy Solution** to sideload the application to your PC.</span></span>
5.  <span data-ttu-id="8c4c5-508">你的应用现在应出现在已安装的应用，准备好启动列表中。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-508">Your App should now appear in the list of installed apps, ready to be launched.</span></span>
6.  <span data-ttu-id="8c4c5-509">启动后，应用将提示你授予对麦克风访问权限。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-509">Once launched, the App will prompt you to authorize access to the Microphone.</span></span> <span data-ttu-id="8c4c5-510">请务必单击**是**按钮。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-510">Make sure to click the **YES** button.</span></span>
7.  <span data-ttu-id="8c4c5-511">现已准备好开始翻译 ！</span><span class="sxs-lookup"><span data-stu-id="8c4c5-511">You are now ready to start translating!</span></span>

## <a name="your-finished-translation-text-api-application"></a><span data-ttu-id="8c4c5-512">完成的翻译文本 API 应用程序</span><span class="sxs-lookup"><span data-stu-id="8c4c5-512">Your finished Translation Text API application</span></span>

<span data-ttu-id="8c4c5-513">祝贺你，构建利用 Azure 翻译文本 API 将语音转换为已翻译的文本的混合的现实应用。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-513">Congratulations, you built a mixed reality app that leverages the Azure Translation Text API to convert speech to translated text.</span></span>

![最终产品。](images/AzureLabs-Lab1-00.png)

## <a name="bonus-exercises"></a><span data-ttu-id="8c4c5-515">Bonus 练习</span><span class="sxs-lookup"><span data-stu-id="8c4c5-515">Bonus exercises</span></span>

### <a name="exercise-1"></a><span data-ttu-id="8c4c5-516">练习 1</span><span class="sxs-lookup"><span data-stu-id="8c4c5-516">Exercise 1</span></span>

<span data-ttu-id="8c4c5-517">可以在文本到语音转换将功能添加到应用程序中，以便在返回的文本所说？</span><span class="sxs-lookup"><span data-stu-id="8c4c5-517">Can you add text-to-speech functionality to the app, so that the returned text is spoken?</span></span>

### <a name="exercise-2"></a><span data-ttu-id="8c4c5-518">练习 2</span><span class="sxs-lookup"><span data-stu-id="8c4c5-518">Exercise 2</span></span>

<span data-ttu-id="8c4c5-519">使用户可以更改应用本身的源和输出的语言 （from 和结束），因此应用程序不需要每次想要更改语言重新生成。</span><span class="sxs-lookup"><span data-stu-id="8c4c5-519">Make it possible for the user to change the source and output languages ('from' and 'to') within the app itself, so the app does not need to be rebuilt every time you want to change languages.</span></span>
