...
2. 在 Visual Studio 中创建新的通用 Windows 应用项目。  对于 HoloLens（第一代），请使用 Visual Studio 2017 或更高版本。  对于 HoloLens 2，请使用 Visual Studio 2019 16.2 或更高版本。 支持 C# 和 C++。 （或按说明[在 Unity 中生成应用](holograms-100.md)。）
