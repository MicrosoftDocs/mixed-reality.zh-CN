...
<td>语音命令</td><td style="text-align: center;"> ✔️</td><td style="text-align: center;"> ✔️</td><td style="text-align: center;"> ✔️（配有头戴显示设备）</td>
</tr>
</table>
...
* **避免使用类似的语音命令** - 避免注册多个听起来非常相似的语音命令。 示例：“显示更多”和“显示商店”就非常相似。
