...
![HoloSketch：用于 HoloLens 的空间布局和 UX 草绘应用。](images/holosketch-image-01-640px.png)<br>
...
通过 OneDrive 将 PNG/JPG 图像或 3D FBX 对象（需要在 Unity 中打包）导入到混合现实空间。

### <a name="manipulate-objects"></a>操作对象

![操作对象](images/manipulate-objects-640px.jpg)

使用熟悉的3D 对象接口操作对象（移动/旋转/缩放）。
...
通过 HoloSketch](images/holosketch-image-04-1000px.png) ![简化过程<br>
*简化了 HoloSketch 的过程*
...
10. 为模型对象准备缩略图。 
   ![将图像拖到 "项目" 面板中，并为对象指定所用的名称。](images/holosketch-15-assetbundles-1000px.png)
...
![将文件添加到文件/文档/HoloSketch/folder](images/holosketch-onedriveupload-1000px.png)
![将在 HoloSketch 的 OneDrive 菜单中看到 "已添加3D 对象"](images/holosketch-14-onedriveexample-1000px.jpg)
...
![如何处理对象](images/holosketch-image-06-1000px.png)<br>
*如何操作对象*
...
<td style="border-style: none"><b>Sebring</b><br>开发人员 @Microsoft</td>
</tr>
</table> 
