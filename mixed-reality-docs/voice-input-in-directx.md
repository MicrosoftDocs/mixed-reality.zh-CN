...
本文介绍如何在适用于 Windows Mixed Reality 的 DirectX 应用程序中实现[语音命令](voice-input.md)和短语识别。

>[!NOTE]
>本文中的代码片段使用C++/cx，而不是 C + + 17 C++兼容的/WinRT，它用于[ C++全息项目模板](creating-a-holographic-directx-project.md)。  概念对于C++/WinRT 项目是等效的，但你需要转换代码。
