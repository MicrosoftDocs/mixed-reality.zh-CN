...
* 环境设置为1以记录环境数据。
* 路径名记录的名称。
* singleSpatialMappingFrame :如果设置为 1, 则仅记录单个空间映射框架。
...
Parameters
* 简介配置文件名称。 可用的配置文件存储在 perfprofiles/配置文件中。 json
