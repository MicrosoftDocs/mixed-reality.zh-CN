...
## <a name="schedule---subject-to-change"></a>日程安排 - 可能随时发生变化
...
|下午 2:30 - 3:30|HoloLens 2 上的 OpenXR：跨平台本机混合现实|Alex Turner|OpenXR 1.0 现已发布！ 你是否计划从头开始为自己的引擎或本机应用构建混合现实支持？ 如果是这样，请了解以下方面的关键详细信息：OpenXR 本机 API 图面、实现 HoloLens 2 的完整功能集的扩展，以及从 Firefox Reality 到 StereoKit 等合作伙伴（他们已提供了在 OpenXR 上构建的应用程序和框架）。 借助 OpenXR，可以构建跨供应商的混合现实引擎以及跨行业中大量设备的本机应用！|[RSVP 页面](https://account.altvr.com/events/1475031737691013286)|
|下午 2:30 - 3:30|从一年的 HoloLens 2 开发中总结出的提示 |Peter Vale|HoloLens 商业化团队将分享从与合作伙伴一年的合作中总结出的提示和经验。  深入了解最常见的问题，以及使 HoloLens 2 应用程序可与客户共享的最佳做法和技术。|[RSVP 页面](https://account.altvr.com/events/1475034807686660828)|
||||||

---

## <a name="code-of-conduct-and-microsoft-standard-event-guidelines"></a>行为准则和 Microsoft 标准活动准则

### <a name="code-of-conduct"></a>行为准则 

***Microsoft 的使命是确保为每个人和每个组织提供支持以使其获得更多成果。这些支持包括所有 Microsoft 活动和聚会（包括数字平台上的活动），我们希望在这些活动中为所有参与者打造有礼节、友好、有趣和包容性的体验。***  

***我们期望所有数字活动参与者都维护此行为准则的准则，它们适用于主要数字活动和所有相关活动。我们不允许任何参与方以任何形式在活动的任何方面（包括商业和社交活动）实施破坏性或不尊重他人的行为、发布此类消息和图像或进行此类互动，无论其位于何处。Microsoft 不允许基于年龄、血统、肤色、性别认同或表达、民族血统、身体或精神残疾、宗教、性取向或适用的当地法律、法规和条例所保护的任何其他特征来实施骚扰或歧视。***  
