...
---
# <a name="add-custom-home-environments"></a>添加自定义家庭环境
...
1. [下载我们的示例幻想岛环境](https://download.microsoft.com/download/B/2/5/B25C1AEF-40CD-4B03-A596-4BCA3D33035A/Fantasy_Island.exe)(链接指向自解压缩可执行文件)。
...
3. 打开**文件资源管理器**并导航到 "环境" 文件夹, 方法是将以下内容`%LOCALAPPDATA%\Packages\EnvironmentsApp_cw5n1h2txyewy\LocalState`粘贴到地址栏中:。
4. 将下载的示例环境复制到此文件夹。
...
默认生成位置位于环境中的 0, 0, 0。 当前无法自定义此位置, 因此, 你必须通过导出环境来修改衍生点, 并将源置于所需的生成点。
