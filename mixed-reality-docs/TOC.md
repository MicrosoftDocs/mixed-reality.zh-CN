...
#### [HoloLens（第 1 代）硬件详细信息](hololens-hardware-details.md)
#### [HoloLens 的帐户](accounts-on-hololens.md)
#### [校准](calibration.md)
#### [商业功能](commercial-features.md)
#### [在 HoloLens 上连接到 Wi-Fi](connecting-to-wi-fi-on-hololens.md)
#### [HoloLens 的环境注意事项](environment-considerations-for-hololens.md)
#### [为 HoloLens 获取应用](get-apps-for-hololens.md)
...
### [跨性能不同的设备缩放 Datascape](case-study-scaling-datascape-across-devices-with-different-performance.md)
...
#### [DirectX 中的凝视、手势和运动控制器](gaze,-gestures,-and-motion-controllers-in-directx.md)
