...
借助 OpenXR，你可以构建面向全息设备（如 HoloLens 2）的引擎，该引擎将数字内容置于真实世界中，就像它确实如此，还可以使用沉浸式设备（如台式计算机的 Windows Mixed Reality 耳机）来隐藏物理世界，并将其替换为数字体验。  OpenXR 可让你编写代码，然后在各种硬件平台上对其进行迁移。
...
有三种类型的 OpenXR 扩展：
* **供应商扩展（例如 `MSFT` ）：** 支持硬件或软件功能中的每个供应商创新。  任何运行时供应商随时都可以引入和交付供应商扩展。
  * **实验性供应商扩展（例如 `MSFT_preview` ）：** 要预览的实验性供应商扩展以收集反馈。  `MSFT_preview`扩展仅适用于开发人员设备，并将在真正的扩展交付时删除。  若要对其进行试验，可以[在开发人员设备上启用预览版扩展](openxr-getting-started.md#using-preview-extensions)。
...
| Direct3D 12 集成 | **`KHR`[预览版运行时](openxr-getting-started.md#using-preview-extensions)中的官方扩展2003：**<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_KHR_D3D12_enable" target="_blank">XR_KHR_D3D12_enable</a></code><br /><p>**稳定运行时中的支持**：可能为 2020 *（已计划）*</p> |
| [未绑定的参考空间 <br /> （全球范围体验）](coordinate-systems.md#building-a-world-scale-experience) | **`MSFT`扩展已发布：**<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_unbounded_reference_space" target="_blank">XR_MSFT_unbounded_reference_space</a></code> |
| [空间定位点](spatial-anchors.md) | **`MSFT`扩展已发布：**<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_spatial_anchor">XR_MSFT_spatial_anchor</a></code> |
| [手动交互 <br /> （手柄/aim 姿势、空气分流、抓住）](hands-and-tools.md)<p>*仅 HoloLens 2*</p> | **`MSFT`扩展已发布：**<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_interaction">XR_MSFT_hand_interaction</a></code> |
| [手型 articulation + 手写网格](hands-and-tools.md)<p>*仅 HoloLens 2*</p> | **`MSFT_preview`[预览版运行时 2001](openxr-getting-started.md#using-preview-extensions)中的扩展：**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_hand_tracking_preview">XR_MSFT_hand_tracking_preview</a></code><br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_hand_tracking_mesh_preview">XR_MSFT_hand_tracking_mesh_preview</a></code><p>** `MSFT` 或 `EXT` 预览版运行时中的扩展**：可能为 2020 *（已计划）*</p> |
| [眼睛凝视](eye-tracking.md)<p>*仅 HoloLens 2*</p> | ** `EXT` [预览版运行时 2003](openxr-getting-started.md#using-preview-extensions)中的扩展**：<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_EXT_eye_gaze_interaction" target="_blank">XR_EXT_eye_gaze_interaction</a></code><p>**稳定运行时中的支持**：可能为 2020 *（已计划）*</p> |
| 与其他 HoloLens Sdk 互操作（例如[QR](qr-code-tracking.md)）<p>*仅 HoloLens 2*</p> | **`MSFT_preview`[预览版运行时 2001](openxr-getting-started.md#using-preview-extensions)中的扩展：**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_spatial_graph_bridge_preview">XR_MSFT_spatial_graph_bridge_preview</a></code><p>** `MSFT` 预览版运行时中的扩展**：可能为 2020 *（已计划）*</p> |
| [混合现实捕获 <br /> （PV 相机的第三个渲染）](mixed-reality-capture-for-developers.md#render-from-the-pv-camera-opt-in)<p>*仅 HoloLens 2*</p> | **`MSFT_preview`[预览版运行时 2003](openxr-getting-started.md#using-preview-extensions)中的扩展：**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_secondary_view_configuration_preview">XR_MSFT_secondary_view_configuration_preview</a></code><br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_first_person_observer_preview">XR_MSFT_first_person_observer_preview</a></code><p>** `MSFT` 预览版运行时中的扩展**：6月 2020 *（已计划）*</p> |
| [运动控制器呈现模型](motion-controllers.md#rendering-the-motion-controller-model) | **`MSFT_preview`[预览版运行时 2003](openxr-getting-started.md#using-preview-extensions)中的扩展：**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_controller_model_preview">XR_MSFT_controller_model_preview</a></code><p>** `MSFT` 预览版运行时中的扩展**：2020年7月 *（已计划）*</p> |
| [场景理解（平面、网格）](scene-understanding.md)<p>*仅 HoloLens 2*</p> | <p>** `MSFT_preview` 预览版运行时中的扩展**：6月 2020 *（已计划）*</p><p>** `MSFT` 预览版运行时中的扩展**：2020年7月 *（已计划）*</p> |
