...
# <a name="mr-sharing-240-multiple-hololens-devices"></a>MR 共享240：多个 HoloLens 设备
...
<td>MR 共享240：多个 HoloLens 设备</td><td style="text-align: center;"> ✔️</td><td style="text-align: center;"> </td>
</tr>
</table>
...
* 单击 "本地计算机" 旁边的下拉箭头，然后选择 "**远程设备**"。
    ...
    * 将**身份验证模式**设置为 "**通用**"。
    * 单击 "**选择**"
* 单击 "**调试" > "开始但不调试**" 或按**Ctrl + F5**。 如果这是首次部署到设备，则需要将[其与 Visual Studio 配对](using-visual-studio.md#pairing-your-device)。
...
在本章中，我们将与全息影像交互。 首先，我们将添加一个光标以直观显示[注视](gaze-and-commit.md)。 接下来，我们将添加[手势](gaze-and-commit.md#composite-gestures)，并使用我们的手在空间中放置全息影像。
